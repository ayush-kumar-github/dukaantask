...
const leftComponent = () => {
  return (
    <>
      ...
      <div className="p-4">
        <ul class="p-2">
          <li class="flex items-center font-bold p-3">
